...
export default function Report(props) {
  ...
  useEffect(() => {
    ...
    domtoimage
      ...
      .then((defaultUrl) => {
        ...
        // 将生成的png图片插入到当前页面
        document.getElementById("reportPage").appendChild(img);
  ...
  return (
    <div className="reportPage">
      <div id="node" className="reportContent" onClick={(event) => {}}>
        ...
        <div className="reportRecom">
          ...
          <div className="reportRecomBed">
            <div className="reportRecomInfo">
              ...
              <div className="reportRecomName">{decodeURI(value.bedName)}</div>
            </div>
              ...
              {new Array(5).fill(0).map((item, index) => {
                return (
                  <img
                    key={index}
                    style={{
                      display: index < Number(value.bedNum) ? "unset" : "none",
                    }}
                    src={star}
                    alt=""
                  />
